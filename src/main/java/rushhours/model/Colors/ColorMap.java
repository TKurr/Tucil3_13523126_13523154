...
public class ColorMap {
    ...
    public ColorMap() {
        ...
        this.colorSet.add(new Color("WHITE",         "\u001B[47;30m"));
        ...
        this.colorSet.add(new Color("BRIGHT_WHITE",   "\u001B[107;30m"));
        this.colorSet.add(new Color("BRIGHT_RED",     "\u001B[101;30m"));
